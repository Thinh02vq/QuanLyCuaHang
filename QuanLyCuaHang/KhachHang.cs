...
namespace QuanLyCuaHang
{
    public partial class frmKhachHang : Form
    {
        ...
        private void dgvKhachHang_Click(object sender, EventArgs e)
        {
            ...
            txtMaKH.Text = dgvKhachHang.CurrentRow.Cells["MaKhachHang"].Value.ToString();
            txtTenKH.Text = dgvKhachHang.CurrentRow.Cells["TenKhachHang"].Value.ToString();
            txtDiaChi.Text = dgvKhachHang.CurrentRow.Cells["DiaChi"].Value.ToString();
            txtDienThoaiKH.Text = dgvKhachHang.CurrentRow.Cells["DienThoai"].Value.ToString();
            btnSua.Enabled = true;
            btnXoa.Enabled = true;
        }
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT MaKhachHang FROM KhachHang WHERE MaKhachHang=N'" + txtMaKH.Text.Trim() + "'";
            ...
            sql = "INSERT INTO KhachHang VALUES (N'" + txtMaKH.Text.Trim() +
                "',N'" + txtTenKH.Text.Trim() + "',N'" + txtDiaChi.Text.Trim() + "','" + txtDienThoaiKH.Text + "')";
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE KhachHang SET TenKhachHang=N'" + txtTenKH.Text.Trim().ToString() + "',DiaChi=N'" +
                txtDiaChi.Text.Trim().ToString() + "',DienThoai='" + txtDienThoaiKH.Text.ToString() +
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "DELETE KhachHang WHERE MaKhachHang=N'" + txtMaKH.Text + "'";
                Functions.RunSQL(sql);
                LoadDataGridView();
                ResetValues();
            }
