...
namespace QuanLyCuaHang
{
    public partial class frmHoaDon : Form
    {
        ...
        private void frmHoaDon_Load(object sender, EventArgs e)
        {
            ...
            txtGiamGia.Text = "0";
            txtTongTien.Text = "0";
            Functions.FillCombo("SELECT MaKhachHang, TenKhachHang FROM KhachHang", cboMaKH, "MaKhachHang", "MaKhachHang");
            cboMaKH.SelectedIndex = -1;
            Functions.FillCombo("SELECT MaNhanVien, TenNhanVien FROM NhanVien", cboMaNV, "MaNhanVien", "TenKhachHang");
        ...
        {
            string sql;
            sql = "SELECT a.MaHang, b.TenHang, a.SoLuong, b.GiaBan, a.GiamGia, a.ThanhTien FROM ChiTietHD AS a, HangHoa AS b WHERE a.MaHoaDon = N'" + txtMaHD.Text + "' AND a.MaHang=b.MaHang";
        ...
        private void LoadInfoHoaDon()
        {
            ...
            dateTimePickerNgayBan.Value = DateTime.Parse(Functions.GetFieldValues(str));
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT MaHoaDon FROM HoaDon WHERE MaHoaDon=N'" + txtMaHD.Text + "'";
            if (!Functions.CheckKey(sql))
            {
                ...
                sql = "INSERT INTO HoaDon(MaHoaDon, NgayBan, MaNhanVien, MaKhachHang, TongTien) VALUES (N'" + txtMaHD.Text.Trim() + "','" +
                        dateTimePickerNgayBan.Value + "',N'" + cboMaNV.SelectedValue + "',N'" +
            ...
            sql = "SELECT MaHang FROM ChiTietHD WHERE MaHang=N'" + cboMaHang.SelectedValue + "' AND MaHoaDon = N'" + txtMaHD.Text.Trim() + "'";
            if (Functions.CheckKey(sql))
            {
            ...
            sql = "INSERT INTO ChiTietHD(MaHoaDon,MaHang,SoLuong,DonGia, GiamGia,ThanhTien) VALUES(N'" + txtMaHD.Text.Trim() + "',N'" + cboMaHang.SelectedValue + "'," + txtSoLuong.Text + "," + txtDonGia.Text + "," + txtGiamGia.Text + "," + txtThanhTien.Text + ")";
            Functions.RunSQL(sql);
            LoadDataGridView();
            ...
            tong = Convert.ToDouble(Functions.GetFieldValues("SELECT TongTien FROM HoaDon WHERE MaHoaDon = N'" + txtMaHD.Text + "'"));
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql = "SELECT MaHang,SoLuong FROM ChiTietHD WHERE MaHoaDon = N'" + txtMaHD.Text + "'";
                ...
                sql = "DELETE ChiTietHD WHERE MaHoaDon=N'" + txtMaHD.Text + "'";
                Functions.RunSQL(sql);
        ...
        private void cboMaKH_TextChanged(object sender, EventArgs e)
        {
            ...
            str = "Select TenKhachHang from KhachHang where MaKhachHang = N'" + cboMaKH.SelectedValue + "'";
            txtTenKH.Text = Functions.GetFieldValues(str);
            str = "Select DiaChi from KhachHang where MaKhachHang = N'" + cboMaKH.SelectedValue + "'";
            txtDiaChi.Text = Functions.GetFieldValues(str);
            str = "Select DienThoai from KhachHang where MaKhachHang= N'" + cboMaKH.SelectedValue + "'";
            txtDienThoaiKH.Text = Functions.GetFieldValues(str);
        }
        ...
        private void btnInHoaDon_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["A1:B1"].Value = "Gia Dụng An Nhiên";
            exRange.Range["A2:B2"].MergeCells = true;
            exRange.Range["A2:B2"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A2:B2"].Value = "Hà Nội";
            exRange.Range["A3:B3"].MergeCells = true;
            exRange.Range["A3:B3"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A3:B3"].Value = "Điện thoại: 0353923019";
            ...
            sql = "SELECT a.MaHoaDon, a.NgayBan, a.TongTien, b.TenKhachHang, b.DiaChi, b.DienThoai, c.TenNhanVien FROM HoaDon AS a, KhachHang AS b, NhanVien AS c WHERE a.MaHoaDon = N'" + txtMaHD.Text + "' AND a.MaKhachHang = b.MaKhachHang AND a.MaNhanVien = c.MaNhanVien";
            ...
            sql = "SELECT b.TenHang, a.SoLuong, b.GiaBan, a.GiamGia, a.ThanhTien " +
                  "FROM ChiTietHD AS a , HangHoa AS b WHERE a.MaHoaDon = N'" +
        ...
        {
            if (((e.KeyChar >= '0') && (e.KeyChar <= '9')) || (Convert.ToInt64(e.KeyChar) == 8))
                e.Handled = false;
            else e.Handled = true;
        }
