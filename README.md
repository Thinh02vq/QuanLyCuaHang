...
## - Về project này
Đây là project được tôi phát triển trong quá trình học tập về C# WinForms và quản lý cơ sở dữ liệu. 
...
## - Cách cài đặt project (Khuyến khích)
...
1. Chuột phải vào thư mục zip của project vừa tải về.
2. Chọn **Properties**.
3. Tại tab **General**, tích vào ô **Unblock** ở dưới cùng.
4. Nhấn **Apply** sau đó **OK** để lưu thay đổi.
5. Mở project trong Visual Studio.

## - Hướng dẫn cài đặt Database
Để chạy project, bạn cần thực hiện khởi tạo database bằng file .sql đính kèm:
...
### Demo Giao Diện: Tài khoản và mật khẩu mặc định cho tài khoản admin là: TK:`admin`, MK:`123456` (để dễ dàng đăng nhập và kiểm tra tính năng).
...
Nếu bạn có bất kỳ góp ý nào để project hoàn thiện hơn, đừng ngần ngại chia sẻ với tôi nhé. 
